...
export default function FormValidation() {
    const cats =[['100','ไอที'],['200','เครื่องจักกล'],['300','เคมีภัณฑ์']]
        ...
        <div className="mt-3 mb-5 mx-auto p-3 rounded" style={{width:'400px',background:'#cee'}}>
            <form onSubmit={handleSubmit(onSubmitForm)}>
                ...
                <div className="form-group mb-3">
                    ...
                    className="form-control form0control-sm"
                ...
                <div className="formgroup mb-3">
                    ...
                    {errors.price && <div style={err}>กำหนดราคาสินค้าต้องเป็นตัวเลขที่มากกว่า 0 </div>}
                </div>
                ...
                <div className="form-group mb-3">
                    <label htmlFor="file" className="form-label">ภาพสินค้า * (ไม่เกิน 3 ไฟล์ขนาดสูงสุด 300 KB/ไฟล์)</label>
